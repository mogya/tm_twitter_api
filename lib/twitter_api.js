...
var TwitterApi = function(params) {
    ...
    */
    ...
    this.statuses_public_timeline = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/public_timeline.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //statuses.home_timeline
    this.statuses_home_timeline = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/home_timeline.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //statuses.friends_timeline
    this.statuses_friends_timeline = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/friends_timeline.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    ...
    this.statuses_mentions = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/mentions.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //statuses.retweeted_by_me
    this.statuses_retweeted_by_me = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/retweeted_by_me.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //statuses.retweeted_to_me
    this.statuses_retweeted_to_me = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/retweeted_to_me.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //statuses.show
    this.statuses_show = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/show/:id.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //statuses.update
    this.statuses_update = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/update.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    //statuses.destroy
    this.statuses_destroy = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/destroy/:id.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    //statuses.retweet
    this.statuses_retweet = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/retweet/:id.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    //statuses.retweets
    this.statuses_retweets = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/retweets/:id.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //statuses.retweeted_by
    this.statuses_retweeted_by = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/:id/retweeted_by.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //statuses.retweeted_by_ids
    this.statuses_retweeted_by_ids = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/:id/retweeted_by/:ids.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    ...
    this.users_show = function(params) {
        params.url = 'https://api.twitter.com/1.1/users/show.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //users.lookup
    this.users_lookup = function(params) {
        params.url = 'https://api.twitter.com/1.1/users/lookup.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //users.search
    this.users_search = function(params) {
        params.url = 'https://api.twitter.com/1.1/users/search.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //users.suggestions
    this.users_suggestions = function(params) {
        params.url = 'https://api.twitter.com/1.1/users/suggestions.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //users.suggestions.twitter
    this.users_suggestions_twitter = function(params) {
        params.url = 'https://api.twitter.com/1.1/users/suggestions/:slug.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //users.profile_image.twitter
    this.users_profile_image_twitter = function(params) {
        params.url = 'https://api.twitter.com/1.1/users/profile_image/:screen_name.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    ...
    this.statuses_friends = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/friends.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //statuses.followers
    this.statuses_followers = function(params) {
        params.url = 'https://api.twitter.com/1.1/statuses/followers.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //trends
    this.trends = function(params) {
        params.url = 'https://api.twitter.com/1.1/trends.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    ...
    this.trends_current = function(params) {
        params.url = 'https://api.twitter.com/1.1/trends/current.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //trends.daily
    this.trends_daily = function(params) {
        params.url = 'https://api.twitter.com/1.1/trends/daily.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //trends.weekly
    this.trends_weekly = function(params) {
        params.url = 'https://api.twitter.com/1.1/trends/weekly.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    ...
    this.user_lists_create = function(params) {
        params.url = 'https://api.twitter.com/1.1/:user/lists.json';
        params.method = 'POST';
    };
    // :user/lists/:id
    // Updates the specified list.
    this.user_lists_update = function(params) {
        params.url = 'https://api.twitter.com/1.1/:user/lists/:id.json';
        params.method = 'POST';
    };
    // :user/lists
    ...
    this.user_lists_statuses = function(params) {
        params.url = 'https://api.twitter.com/1.1/:user/lists/:id/statuses.json';
        params.method = 'GET';
    };
    // :user/lists/memberships
    // List the lists the specified user has been added to.
    this.user_lists_memberships = function(params) {
        params.url = 'https://api.twitter.com/1.1/:user/lists/memberships.json';
        params.method = 'GET';
    };
    // :user/lists/subscriptions
    // List the lists the specified user follows.
    this.user_lists_subscriptions = function(params) {
        params.url = 'https://api.twitter.com/1.1/:user/lists/subscriptions.json';
        params.method = 'GET';
    };

    //direct_messages
    this.direct_messages = function(params) {
        params.url = 'https://api.twitter.com/1.1/direct_messages.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //direct_messages.sent
    this.direct_messages_sent = function(params) {
        params.url = 'https://api.twitter.com/1.1/direct_messages/sent.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //direct_messages.new
    this.direct_messages_new = function(params) {
        params.url = 'https://api.twitter.com/1.1/direct_messages/new.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    ...
    this.friendships_create = function(params) {
        params.url = 'https://api.twitter.com/1.1/friendships/create.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //friendships.destroy
    this.friendships_destroy = function(params) {
        params.url = 'https://api.twitter.com/1.1/friendships/destroy/:id.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //friendships.exists
    this.friendships_exists = function(params) {
        params.url = 'https://api.twitter.com/1.1/friendships/exists.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //friendships.show
    this.friendships_show = function(params) {
        params.url = 'https://api.twitter.com/1.1/friendships/show.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //friendships.incoming
    this.friendships_incoming = function(params) {
        params.url = 'https://api.twitter.com/1.1/friendships/incoming.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    ...
    this.account_rate_limit_status = function(params) {
        params.url = 'https://api.twitter.com/1.1/account/rate_limit_status.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //account.end_session
    this.account_end_session = function(params) {
        params.url = 'https://api.twitter.com/1.1/account/end_session.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    //account.update_delivery_device
    this.account_update_delivery_device = function(params) {
        params.url = 'https://api.twitter.com/1.1/account/update_delivery_device.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    //account.update_profile_colors
    this.account_update_profile_colors = function(params) {
        params.url = 'https://api.twitter.com/1.1/account/update_profile_colors.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    //account.update_profile_image
    this.account_update_profile_image = function(params) {
        params.url = 'https://api.twitter.com/1.1/account/update_profile_image.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    //account.update_profile_background_image
    this.account_update_profile_background_image = function(params) {
        params.url = 'https://api.twitter.com/1.1/account/update_profile_background_image.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    ...
    this.favorites = function(params) {
        params.url = 'https://api.twitter.com/1.1/favorites.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //favorites.create
    this.favorites_create = function(params) {
        params.url = 'https://api.twitter.com/1.1/favorites/create/:id.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    //favorites.destroy
    this.favorites_destroy = function(params) {
        params.url = 'https://api.twitter.com/1.1/favorites/destroy:id.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    ...
    this.blocks_create = function(params) {
        params.url = 'https://api.twitter.com/1.1/blocks/create.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    ...
    this.blocks_destroy = function(params) {
        params.url = 'https://api.twitter.com/1.1/blocks/destroy.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    //blocks.exists
    this.blocks_exists = function(params) {
        params.url = 'https://api.twitter.com/1.1/blocks/exists.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //blocks.blocking
    this.blocks_blocking = function(params) {
        params.url = 'https://api.twitter.com/1.1/blocks/blocking.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //blocks.blocking_ids
    this.blocks_blocking_ids = function(params) {
        params.url = 'https://api.twitter.com/1.1/blocks/blocking/:ids.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    ...
    this.report_spam = function(params) {
        params.url = 'https://api.twitter.com/1.1/report_spam.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    ...
    this.saved_searches = function(params) {
        params.url = 'https://api.twitter.com/1.1/saved_searches.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //saved_searches.show
    this.saved_searches_show = function(params) {
        params.url = 'https://api.twitter.com/1.1/saved_searches/show.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //saved_searches.create
    this.saved_searches_create = function(params) {
        params.url = 'https://api.twitter.com/1.1/saved_searches/create.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    //saved_searches.delete
    this.saved_searches_delete = function(params) {
        params.url = 'https://api.twitter.com/1.1/saved_searches/destroy.json';
        params.method = 'POST';
        return self.callApi(params);
    };
    ...
    this.geo_search = function(params) {
        params.url = 'https://api.twitter.com/1.1/geo/search.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //geo.similar_places
    this.geo_similar_places = function(params) {
        params.url = 'https://api.twitter.com/1.1/geo/similar_places.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //geo.reverse_geocode
    this.geo_reverse_geocode = function(params) {
        params.url = 'https://api.twitter.com/1.1/geo/reverse_geocode.json';
        params.method = 'GET';
        return self.callApi(params);
    };
    //geo.id.place
    this.geo_id_place = function(params) {
        params.url = 'https://api.twitter.com/1.1/geo/id/:place_id.json';
        params.method = 'GET';
        return self.callApi(params);
    };
};
